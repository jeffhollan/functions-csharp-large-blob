...
namespace ZipLargeFile
{
    public static class gzip_file
    {
        ...
        public static void Run([BlobTrigger("largeitems/{name}"), Disable()]Stream blob, string name, TraceWriter log, [Blob("largezips/{name}.gz", FileAccess.Write)] Stream outputblob)
        {
